package ru.t1.OpenSchoolT1.config;
...
import ru.t1.OpenSchoolT1.kafka.MessageDeserializer;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, TaskDTO> consumerListenerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "ru.t1.OpenSchoolT1.dto.TaskDTO");
